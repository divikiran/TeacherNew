...
{
    public class PictureImageSourceConverter : IValueConverter
    {
        ...
        public object Convert( object value, Type targetType, object parameter, CultureInfo culture )
        {
            ...
            else if( !string.IsNullOrWhiteSpace( model.BaseUrl ) && Uri.TryCreate( string.Format( model.BaseUrl, model.Id ), UriKind.Absolute, out result ) )
            {
